// ----------------------------
// Shadi Badir
// This file includes the mount_ns functions,
// and I have added the code for the implementation of allocmount_ns within it.
// ----------------------------
...
static struct mount_ns* allocmount_ns()
{
  ...
  // It is necessary to verify whether a namespace is currently available.
   for (int i = 0; i < NNAMESPACE; i++) {
